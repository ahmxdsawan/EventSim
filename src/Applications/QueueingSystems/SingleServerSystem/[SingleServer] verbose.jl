...
verbose(::☼Time☼,  sim::SSSystem, currTime::Int)     =  @printf("[%7d]", currTime)
verbose(::☼Time☼,  sim::SSSystem, currTime::Float64) =  @printf("[%4.1f]", currTime)

☼preevent(sim::SSSystem, name)        =  @printf("[%4s] %-7s %6s", "--", name, "--")
